...
# > Before running this notebook, attach **RetailLakehouse** as the default lakehouse (View menu ▸ Lakehouse
# > explorer ▸ Add) — otherwise `spark.table("silver.*")` cannot resolve.
